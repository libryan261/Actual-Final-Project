...
Based on the results and graphs that we made, we do not have statistically significant evidence to say that the availability of jobs and the median value of homes are affected by racial inequality.
