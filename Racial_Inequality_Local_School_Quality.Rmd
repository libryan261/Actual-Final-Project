...
With the data and stats provided, we can say that there is enough statistically signicant evidence to say that the education quality and the median house value is in part due to racial inequality in the housing market.
