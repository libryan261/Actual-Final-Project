...
Based on the linear regression that was run between the two variables, we can see that with the p-value below our alpha level it signals that there is evidence to claim that there is an influence by racial differences on the relationship of the varibles.